...
from models.models import listar_reservas, eliminar_reserva
...
class VerReservasWindow(ctk.CTkToplevel):
    def __init__(self, parent):
        ...
        cols = ("ID", "Cliente", "Cancha", "Tipo", "Fecha", "Hora", "Observaciones")
        self.tree = ttk.Treeview(tree_frame, columns=cols, show="headings", style="Club.Treeview")
        widths = {"ID": 45, "Cliente": 160, "Cancha": 140, "Tipo": 85, "Fecha": 100, "Hora": 65, "Observaciones": 190}
        for c in cols:
